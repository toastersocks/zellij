...
#[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum ActionType {
        ...
        JumpToPreviousPrompt(super::JumpToPreviousPromptAction),
        #[prost(message, tag="142")]
        JumpToNextPrompt(super::JumpToNextPromptAction),
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct JumpToPreviousPromptAction {
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct JumpToNextPromptAction {
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
